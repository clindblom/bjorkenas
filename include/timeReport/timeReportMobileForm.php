<?php
	...
	if($weekNoDB == $year.''.$week) {
		...
		echo '<form id="createTimeReportForm" name="updateTimeReportForm" action="include/timeReport/timeReportUpdate.php" method="post">
					...
					<input class="btn btn-default" type="submit"  value="Rapportera" style="float:left; margin-right:10px; margin-bottom:15px"/>';
		...
		echo '<table class="table" id="reportTimeTable">';
			...
			for($t=0; $t<$noOfRows; $t++) {
				...
				echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
				...
				echo '</tr>';
				echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
					echo '<td style="border:none;">Arbetsorder</td>';
					echo '<td>Tid</td>';		
					echo '<td>Resa</td>';		
					echo '<td>Tid</td>';		
					echo '<td>Resa</td>';		
				...
				echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
					  	...
					  	if ($orderNoArraydb[$t] == 0) {
					  		echo '<td style="width:15%; border:none">
			...
			echo '<tfoot>';
				echo '<tr style="border-top:5px solid #ddd;">';
					echo '<th></th>';
					echo '<th colspan=2>Måndag</th>'; 
					echo '<th colspan=2>Tisdag</th>';
					echo '<th colspan=2>Onsdag</th>';
				...
				echo '</tr>';
				echo '<tr>';
					echo '<td style="border:none;">Summa</td>';
		...
		echo '</form>';
			...
			for($t=0; $t<8; $t++) {
				...
				echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
						...
						echo '<td><input type="text" class="form-control" id="montime'.$t.'" name="montime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="montrip'.$t.'" name="montrip'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="tuetime'.$t.'" name="tuetime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="tuetrip'.$t.'" name="tuetrip'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="wentime'.$t.'" name="wentime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="wentrip'.$t.'" name="wentrip'.$t.'"></td>';
						echo '<td></td>';
						echo '<td></td>';
					echo '</tr>';
					echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
					...
					echo '<tr '; if (($t % 2) == 0) { echo 'style="background-color:#F5F5F5"';} echo '>';
						echo '<td style="border:none;"></td>';
						echo '<td><input type="text" class="form-control" id="thutime'.$t.'" name="thutime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="thutrip'.$t.'" name="thutrip'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="fritime'.$t.'" name="fritime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="fritrip'.$t.'" name="fritrip'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="sattime'.$t.'" name="sattime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="sattrip'.$t.'" name="sattrip'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="suntime'.$t.'" name="suntime'.$t.'"></td>';
						echo '<td><input type="text" class="form-control" id="suntrip'.$t.'" name="suntrip'.$t.'"></td>';
					echo '</tr>';
